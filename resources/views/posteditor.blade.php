    ...
    <div class="card-body">
        <form method="POST" action="{{ route('post.update',$post->id)}}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="TitleInput" aria-describedby="titleHelp" name="title" value="{{$post->title}}">
                <div id="titleHelp" class="form-text">標題要5~25個字</div>
            </div>
            <div class="mb-3">
                <label for="ContentInput" class="form-label">內容</label>
                <textarea class="form-control" id="ContentInput" rows="3" aria-describedby="contentHelp" name="content">{{$post->content}}</textarea>
